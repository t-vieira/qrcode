    ...
    <div class="flex h-screen">
        ...
        <div id="sidebar" 
            ...
            <nav class="flex-1 px-6 py-4">
                ...
                <div class="mt-8">
                    <div class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Estatísticas</div>
                    <a href="{{ route('reports') }}" 
                       class="nav-item flex items-center px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('reports') ? 'active-nav-item' : 'text-gray-700 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                        </svg>
                        Estatísticas
